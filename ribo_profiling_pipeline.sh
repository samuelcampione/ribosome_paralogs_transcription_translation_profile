...
while IFS= read -r srr; do
    ...
    echo "Using featureCounts"
    featureCounts -T 1 -g gene_name -s 1 -Q 10 \
                -a /Users/scampione/data/Blevins_Tavella_etal_Scer_transcriptome.gtf \
                -o quality_threshold_10_yes_stranded_Blevins_Tavella_gtf_featureCounts_${srr}_full.txt \
    ...
    # echo "Using Blevins_Tavella annotation file stranded=yes, adjusted quality threshold to 0"
    ...
    #             filtered_aligned_reads_${srr}.bam \
    #             /Users/scampione/data/Blevins_Tavella_etal_Scer_transcriptome.gtf \
    #             > quality_threshold_0_yes_stranded_Blevins_Tavella_gtf_counts_${srr}_full.txt

    # echo "Using Blevins_Tavella annotation file stranded=yes, adjusted quality threshold to 1"
    # htseq-count -f bam -m intersection-strict --minaqual 1 \
    #             -s yes \
    #             -q \
    #             -i gene_name \
    #             filtered_aligned_reads_${srr}.bam \
    #             /Users/scampione/data/Blevins_Tavella_etal_Scer_transcriptome.gtf \
    #             > quality_threshold_1_yes_stranded_Blevins_Tavella_gtf_counts_${srr}_full.txt


    # echo "Using Blevins_Tavella annotation file stranded=yes, adjusted quality threshold to 0, overlap mode=union"
    ...
    #             filtered_aligned_reads_${srr}.bam \
    #             /Users/scampione/data/Blevins_Tavella_etal_Scer_transcriptome.gtf \
    #             > union_quality_threshold_0_yes_stranded_Blevins_Tavella_gtf_counts_${srr}_full.txt


    # echo "Subsampling"
    # samtools view -b -s 0.4 -o half_subsampled_aligned_reads_${srr}.bam filtered_aligned_reads_${srr}.bam

    # echo "Subsampled: Using Blevins_Tavella annotation file stranded=yes"
    # htseq-count -f bam -m intersection-strict \
    #             -s yes \
    #             -q \
    #             -i gene_name \
    #             half_subsampled_aligned_reads_${srr}.bam \
    #             /Users/scampione/data/Blevins_Tavella_etal_Scer_transcriptome.gtf \
    #             > yes_stranded_Blevins_Tavella_gtf_counts_${srr}_subset.txt
